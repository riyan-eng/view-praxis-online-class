<template>
         ...
         <div class="row">
             ...
             <div class="col-lg-6 col-xl-7">
                 <div class="image-container">
                     <img class="img-fluid" src="/src/assets/images/header-image.png" alt="alternative" />
                 </div> 
             </div> 
         </div> 
     </div> 
   ...
   <div id="details" class="basic-1">
     <div class="container">
         <div class="row">
             <div class="col-lg-6 col-xl-7">
                 <div class="image-container">
                     <img class="img-fluid" src="/src/assets/images/details-1.png" alt="alternative" />
                 </div> 
             </div> 
             <div class="col-lg-6 col-xl-5">
                 <div class="text-container">
   ...
   <div class="basic-2">
     <div class="container">
         <div class="row">
             ...
             <div class="col-lg-6 col-xl-7">
                 <div class="image-container">
                     <img class="img-fluid" src="/src/assets/images/details-2.png" alt="alternative" />
                 </div> 
             </div> 
         </div>
     </div> 
   ...
   <div id="features" class="accordion-1">
     <div class="container">
         ...
         <div class="row">
             ...
             <div class="col-xl-7">
                 <div class="image-container">
                     <img class="img-fluid" src="/src/assets/images/features-dashboard.png" alt="alternative"/>
                 </div> 
             </div> 
         </div>
     </div> 
     ...
     <div class="container">
         ...
         <div class="row">
             <div class="col-lg-12">
                 ...
                 <div class="card">
                     <img class="quotes" src="/src/assets/images/quotes.svg" alt="alternative" />
                     <div class="card-body">
                     ...
                     <div class="swiper-container image-slider">
                         <div class="swiper-wrapper">
                             <div class="swiper-slide">
                                 <img class="img-fluid" src="/src/assets/images/customer-logo-1.png" alt="alternative" />
                             </div>
                             <div class="swiper-slide">
                                 <img class="img-fluid" src="/src/assets/images/customer-logo-2.png" alt="alternative" />
                             </div>
                             <div class="swiper-slide">
                                 <img class="img-fluid" src="/src/assets/images/customer-logo-3.png" alt="alternative" />
                             </div>
                             <div class="swiper-slide">
                                 <img class="img-fluid" src="/src/assets/images/customer-logo-4.png" alt="alternative" />
                             </div>
                             <div class="swiper-slide">
                                 <img class="img-fluid" src="/src/assets/images/customer-logo-5.png" alt="alternative" />
                             </div>
                             <div class="swiper-slide">
                                 <img class="img-fluid" src="/src/assets/images/customer-logo-6.png" alt="alternative" />
                             </div>
                         </div>
                     </div> 
                 </div> 
   ...
   <div class="footer bg-gray">
     <img class="decoration-circles" src="/src/assets/images/decoration-circles.png" alt="alternative" />
     <div class="container">
         <div class="row">
             <div class="col-lg-12">
   ...
   <button id="myBtn">
     <img src="/src/assets/images/up-arrow.png" alt="alternative" />
   </button>
   </template>
